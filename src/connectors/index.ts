...
const RPC = {
  ...
  [SupportedChainId.METERTEST]: "https://rpctest.meter.io/",
  [SupportedChainId.METERMAINNET]: "https://rpc.meter.io/",
};
...
const supportedChainIds = [3, 4, 56, 97, 80001, 137, 42261, 42262, 83, 82];
